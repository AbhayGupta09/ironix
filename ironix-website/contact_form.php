...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Username = 'info@ironix.techcov.in';      // SMTP username
        $mail->Password = '@Ironix_0001';               // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;   // Enable TLS encryption
        $mail->Port = 587;                               // TCP port to connect to

        // Send to the owner
        $mail->setFrom('info@ironix.techcov.in', 'Techcov Bot'); // Sender
        $mail->addAddress('Shivachaudharyfitness@gmail.com');         // Owner's email
        ...
        $mail->setFrom('info@ironix.techcov.in', 'Sai Picture Kasganj'); // Sender
